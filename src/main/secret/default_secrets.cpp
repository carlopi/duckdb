...
vector<CreateSecretFunction> CreateHTTPSecretFunctions::GetDefaultSecretFunctions() {
	...
	http_config_fun.named_parameters["use_ssl"] = LogicalType::BOOLEAN;
	...
	http_env_fun.named_parameters["use_ssl"] = LogicalType::BOOLEAN;
...
unique_ptr<BaseSecret> CreateHTTPSecretFunctions::CreateHTTPSecretFromEnv(ClientContext &context,
	...
	// Allow overwrites
	secret->secret_map["use_ssl_is_set"] = secret->TrySetValue("use_ssl", input);
