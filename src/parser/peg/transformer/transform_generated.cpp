...
PEGTransformerFactory::TransformCreateExternalResourceStmtInternal(PEGTransformer &transformer,
	...
	auto result = TransformCreateExternalResourceStmt(transformer, std::move(expression), attach_alias, attach_options);
	return make_uniq<TypedTransformResult<unique_ptr<SQLStatement>>>(std::move(result));
}

unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformAdoptExternalResourceStmtInternal(PEGTransformer &transformer,
                                                                  ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto expression = transformer.Transform<unique_ptr<ParsedExpression>>(list_pr.GetChild(3));
	optional<Identifier> attach_alias {};
	...
	auto expression_1 = transformer.Transform<unique_ptr<ParsedExpression>>(list_pr.GetChild(6));
	auto result =
	    TransformAdoptExternalResourceStmt(transformer, std::move(expression), attach_alias, std::move(expression_1));
	return make_uniq<TypedTransformResult<unique_ptr<SQLStatement>>>(std::move(result));
}
...
void PEGTransformerFactory::RegisterGenerated() {
	static const TransformRule builtin_transform_rules[] = {
	    ...
	    {"AdoptExternalResourceStmt", &PEGTransformerFactory::TransformAdoptExternalResourceStmtInternal},
