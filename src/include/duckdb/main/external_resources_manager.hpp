...
//! A provisioned external resource this instance owns, registered under a local name (from CREATE/ADOPT
...
//! what it manages, rebuilt across restarts via ADOPT. A name is claimed by its first registration.
