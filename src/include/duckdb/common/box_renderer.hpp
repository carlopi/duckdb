...
public:
	...
	string ToString(BaseClientContext &context, const vector<string> &names, const ColumnDataCollection &op);

	unique_ptr<BoxRendererState> Prepare(BaseClientContext &context, const vector<string> &names,
	                                     const ColumnDataCollection &op);
	void Render(BaseClientContext &context, const vector<string> &names, const ColumnDataCollection &op,
	            BaseResultRenderer &ss);
	void Print(BaseClientContext &context, const vector<string> &names, const ColumnDataCollection &op);
