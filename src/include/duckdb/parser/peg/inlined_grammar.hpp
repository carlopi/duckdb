...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"CreateExternalResourceStmt <- 'CREATE' 'EXTERNAL' 'RESOURCE' StringLiteral AttachAlias? ExternalResourceOptions?\n"
	...
	"ShowAllModifier <- 'ALL'\n"
	"# WITH marks recipe create params, as opposed to the bare option list of the DuckDB-side statement.\n"
	"ExternalResourceOptions <- 'WITH' GenericCopyOptionList\n"
