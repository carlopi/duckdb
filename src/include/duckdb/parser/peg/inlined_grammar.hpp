...
const char INLINED_PEG_GRAMMAR[] = {
    ...
    "TypeVariations <- TimeType / IntervalType / BitType / RowType / VariantType / MapType / GeometryType / UnionType "
    "/ NumericType / SetofType / SimpleType\n"
    ...
    "IgnoreOrRespectNulls?) WithinGroupClause? FilterClause? ExportClause? OverClause?\n"
    ...
    "TopLevelConstraintList <- TopPrimaryKeyConstraint / CheckConstraint / TopUniqueConstraint / "
