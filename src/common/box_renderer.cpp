...
struct RenderDataCollection {
	RenderDataCollection(BaseClientContext &context, idx_t column_count);
...
struct BoxRendererImplementation : public BoxRendererState {
	BoxRendererImplementation(BoxRendererConfig config, BaseClientContext &context, const vector<string> &names,
...
BoxRendererImplementation::BoxRendererImplementation(BoxRendererConfig config_p, BaseClientContext &context,
...
RenderDataCollection::RenderDataCollection(BaseClientContext &context, idx_t column_count) : context(context) {
...
string BoxRenderer::ToString(BaseClientContext &context, const vector<string> &names,
                             const ColumnDataCollection &result) {
...
void BoxRenderer::Print(BaseClientContext &context, const vector<string> &names, const ColumnDataCollection &result) {
	Printer::Print(ToString(context, names, result));
}

unique_ptr<BoxRendererState> BoxRenderer::Prepare(BaseClientContext &context, const vector<string> &names,
                                                  const ColumnDataCollection &result) {
	return make_uniq<BoxRendererImplementation>(config, context, names, result);
}

void BoxRenderer::Render(BaseClientContext &context, const vector<string> &names, const ColumnDataCollection &result,
