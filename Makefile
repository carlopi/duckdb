...
ifneq (${GIT_COMMIT_HASH}, "")
	CMAKE_VARS:=${CMAKE_VARS} -DGIT_COMMIT_HASH=$(GIT_COMMIT_HASH)
endif
ifneq (${GIT_LAST_TAG}, "")
	CMAKE_VARS:=${CMAKE_VARS} -DGIT_LAST_TAG=$(GIT_LAST_TAG)
endif
ifneq (${GIT_ITERATION}, "")
	CMAKE_VARS:=${CMAKE_VARS} -DGIT_ITERATION=$(GIT_ITERATION)
endif
